...
@section('title', 'Продажа сервиса | Знакомства Казахстан')

@section('meta_description', 'Действующий сервис знакомств в Казахстане продаётся. Готовый бизнес с трафиком, базой анкет и Telegram-ботом.')
...
<div class="sale-wrap">
    ...
    <div class="sale-card">
        ...
        <ul class="sale-list">
            <li><span class="ic">✓</span> Сайт-площадка знакомств (анкеты) по Казахстану</li>

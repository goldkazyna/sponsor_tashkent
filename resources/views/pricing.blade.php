...
<div class="pricing-container">
    ...
    <div class="pricing-grid">
        ...
        <div class="pricing-card">
            ...
            <h3 class="card-title">Проверенный спонсор на 5 дней</h3>
        ...
        <div class="pricing-card">
            ...
            <h3 class="card-title">Проверенный спонсор на 10 дней</h3>
        ...
        <div class="pricing-card">
            ...
            <h3 class="card-title">Проверенный спонсор на 1 месяц</h3>

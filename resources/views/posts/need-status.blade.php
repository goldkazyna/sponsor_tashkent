...
@section('title', 'Необходим статус проверенного пользователя')
...
<div class="need-status-container">
    <div class="need-status-card">
        ...
        <h1>Необходим статус проверенного пользователя</h1>
        <p>
            Для добавления объявления мужчинам необходимо приобрести статус проверенного пользователя.

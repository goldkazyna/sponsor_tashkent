...
<div class="rules-container">
    ...
    <div class="rules-card">
        ...
        <div class="rules-section">
            ...
            <p style="margin-top: 1rem;">В целях обеспечения безопасности пользователей, борьбы с мошенничеством, спамом и противоправным контентом, на платформе функционирует автоматизированная система модерации (включая алгоритмы искусственного интеллекта), которая осуществляет анализ текстовых сообщений во внутриплатформенных чатах. Регистрируясь на сайте, пользователь выражает своё полное согласие на автоматизированную обработку передаваемых сообщений.</p>
        </div>

    ...
    <div class="rules-card">
        ...
        <div class="rules-section">
            ...
            <ul>
                ...
                <li>Предложение и реклама интимных услуг — сайт не является площадкой для эскорта.</li>
        ...
        <div class="disclaimer-block">
            <h3>Дисклеймер</h3>
            <p>Данный сайт является площадкой для традиционных знакомств и не оказывает никаких услуг интимного характера. Администрация сайта не организует встречи и не является посредником в отношениях между пользователями.</p>

...
<div class="verified-container">
    ...
    {{-- Ручная оплата переводом на карту (одна карточка, 30 дней / $30). Восстановить онлайн-тарифы — раскомментировать .tariffs-grid ниже. --}}
    <div class="manual-pay-card">
        ...
        <ul class="tariff-features manual-pay-features">
            <li>
                ...
                <strong>Сможете давать объявления</strong>
            </li>
            <li>
                <svg viewBox="0 0 24 24"><path d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z"/></svg>
                Значок проверенного
    ...
    <div class="verified-info">
        ...
        <ul class="info-list">
            <li>
                <svg viewBox="0 0 24 24"><path d="M19,3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3M17,13H13V17H11V13H7V11H11V7H13V11H17V13Z"/></svg>
                <strong>Возможность давать объявления</strong>
            </li>
            <li>

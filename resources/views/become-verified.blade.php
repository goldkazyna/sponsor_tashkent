...
@section('title', 'Купить статус проверенного спонсора')
...
<div class="contact-container">
    ...
    <div class="contact-form-wrapper">
        ...
        <div class="form-header">
            <h1>Купить статус проверенного спонсора</h1>
            <p>Получите значок проверенного спонсора и повысьте доверие к вашему профилю</p>

...
CHANGES: <если ты что-то изменил — ЧЕСТНО и ТОЧНО перечисли каждое изменение через « - ». Пиши конкретно что было и что стало, например «заменено "финансовой основе" на "долгосрочной основе"». НЕ выдумывай изменения которых не делал. Если извлёк контакт, напиши что он добавлен в специальное поле. Если ничего не менял — пусто>
TITLE: <заголовок>
